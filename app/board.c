...
static struct led_desc _led1 = { GPIOE, GPIO_Pin_9, Bit_SET, Bit_RESET};
static struct led_desc _led2 = { GPIOB, GPIO_Pin_0, Bit_SET, Bit_RESET};
static struct led_desc _led3 = { GPIOB, GPIO_Pin_1, Bit_SET, Bit_RESET};
